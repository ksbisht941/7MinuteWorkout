...
import kotlinx.android.synthetic.main.dialog_custom_back_comformation.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView() {
        try {
//            val soudURI = Uri.parse("android:resource://io.ksbisht.a7minuteworkout/" + R.raw.press_start)
    ...
    private fun customDialogForBackButton() {
        ...
        customDialog.setContentView(R.layout.dialog_custom_back_comformation)
